...
if (env === 'development') {
  sequelize = new _sequelize2.default(process.env.DEV_DB_URI);
} else if (env === 'test') {
  sequelize = new _sequelize2.default(process.env.TEST_DB_URI);
} else {
  sequelize = new _sequelize2.default(process.env.DATABASE_URI);
}
